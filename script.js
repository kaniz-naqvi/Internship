...
let projects=[
    ...
    <ul>
        ...
        <li><strong>Interactive Hamburger Menu</strong>: Provides intuitive navigation, with a collapsible design for ease of use.</li>
    ...
    {
      projectLink:"CodeAlpha-project-portfolio/portfolio.html", projrctName:"Portfolio Web",  code:"https://github.com/kaniz-naqvi/Internship/tree/main/CodeAlpha-project-portfolio",
       projectDetails:`<p>
      The <strong>Calculator</strong> web application is a responsive and interactive tool designed for performing basic arithmetic operations. Built with <strong>HTML</strong>, <strong>CSS</strong>, and <strong>JavaScript</strong>, it features a user-friendly interface and dynamic functionality.
  </p>
