...
let projects=[
    {
        projectLink:"CodeAlpha_Project-IMAGE-GALLERY/gallery.html", projrctName:"Image Gallery", livePreview:"", code:"",
...
projects.forEach(project => {
    main.innerHTML=`<div>
            <ol>
                <h2><li><a href="${project.projectLink}">${project.projrctName}</a></li></h2>
                <ul>
                <li>
                    <details>
                ...
                <li><a href="${project.livePreview}">Live preview</a></li>
                <li><a href="${project.code}">Go to Code</a></li>
                </ul>
